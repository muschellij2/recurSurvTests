...
zhao_validation <- function(input = "data-raw/zhao-2020-table-simulations",
  ...
  lines <- c("# Validation against Zhao et al. (2020) simulations", "",
    ...
    if (nrow(worst)) sprintf("Across available comparable power cells, present minus published power ranges from %+.2f to %+.2f percentage points. These differences require investigation of both the data-generating design and the implementation; this report does not identify a unique cause.",
